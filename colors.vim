...
let g:dracula#palette.bg        = ['#1e1e2e', 236]
...
let g:dracula#palette.subtle    = ['#282f3e', 238]

let g:dracula#palette.cyan      = ['#54c0cf', 117]
let g:dracula#palette.green     = ['#39da8a',  84]
let g:dracula#palette.orange    = ['#FFB86C', 215]
let g:dracula#palette.pink      = ['#d5cddf', 212]
let g:dracula#palette.purple    = ['#8bb0f3', 141]
let g:dracula#palette.red       = ['#FF5555', 203]
let g:dracula#palette.yellow    = ['#a4f993', 228]
...
let g:dracula#palette.color_2  = '#39da8a'
let g:dracula#palette.color_3  = '#fcca50'
